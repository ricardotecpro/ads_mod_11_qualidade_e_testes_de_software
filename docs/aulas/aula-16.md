...
<div id="termynal" data-termynal>
    ...
    <span data-ty="input">./run-all-tests.sh</span>
    <span data-ty="progress"></span>
    <span data-ty>Testes Unitários: ✅ PASSED</span>
    <span data-ty>Testes de API: ✅ PASSED</span>
    <span data-ty>Testes Web (E2E): ✅ PASSED</span>
    <span data-ty>Projeto Validado. Parabéns, você é um QA de Sucesso! 🚀</span>
</div>
